# Сборка из исходников Spark, Hive, Hadoop, Zookeper, Mesos, BigData, Tensorflow... в Gentoo. Experimental Gentoo overlay with primary focus on AI frameworks, GPU acceleration, BigData and high-performance Java.
...
```
* ebuilds Solr для Gentoo. Сборка из исходников Solr в Gentoo : : BigdataOverlay
https://github.com/gridgentoo/gentoo-tensorflow-overlay/blob/master/dev-db/apache-solr-bin/apache-solr-bin-7.2.1.ebuild
...
* ebuilds Hbase для Gentoo. Сборка из исходников Hbase в Gentoo : : BigdataOverlay

https://github.com/gridgentoo/gentoo-tensorflow-overlay/blob/master/dev-db/apache-hbase-bin/apache-hbase-bin-1.4.0.ebuild
